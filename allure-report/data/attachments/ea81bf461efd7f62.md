...
Locator: locator('.inventory_details_name large_size')
...
Call log:
  ...
  - waiting for locator('.inventory_details_name large_size')
...
> 65 |         await expect(this.page.locator('.inventory_details_name large_size')).toHaveText(productName)
     |                                                                               ^ Error: expect(locator).toHaveText(expected) failed
  66 | 
