...
> 10 |             console.log(testData.productName[1])
     |                                             ^ TypeError: Cannot read properties of undefined (reading '1')
  11 | 
  12 |         await productPage.clickAddToCart(1)
  13 |         await productPage.clickCartIcon()
  14 |         await productPage.VerfiyCartNavigation('https://www.saucedemo.com/cart.html')
  15 |         await productPage.verfiyProductName(testData.productName[1],1)
  16 |     })
  17 | })
```