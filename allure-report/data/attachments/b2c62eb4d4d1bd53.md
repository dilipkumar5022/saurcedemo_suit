...
Locator: locator('.inventory_details_name large_size').nth(1)
...
Call log:
  ...
  - waiting for locator('.inventory_details_name large_size').nth(1)
...
> 65 |         await expect(this.page.locator('.inventory_details_name large_size').nth(index)).toHaveText(productName)
     |                                                                                          ^ Error: expect(locator).toHaveText(expected) failed
  66 | 
  67 |         await this.verfiyProductPrice(productPrice,index)
  68 |         await this.verifyProductImage(productImage,index)
  69 |         await this.verifyProductButton(index)
